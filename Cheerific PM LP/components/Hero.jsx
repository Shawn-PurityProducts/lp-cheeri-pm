...
const _abVariant = (window.CHEERI_AB) || 'a';
const _abHeadline = _abVariant === 'b'
        ...
        <div className="hero-stacked-row">
          <div>
            <h1 style={heroStyles.h1}>
              {_abHeadline || (<>If Your 2pm Coffee Stopped Hitting The Way It Used To, Here's What Thousands Of Perimenopausal Women Are Drinking Instead{' '}<span style={heroStyles.h1Accent}>(7 Reasons)</span></>)}
            </h1>
          </div>
      ...
      >
        ...
        <div style={{
          ...
          <h1 style={{
            ...
            {_abHeadline || (<>If Your 2pm Coffee Stopped Hitting The Way It Used To, Here's What Thousands Of Perimenopausal Women Are Drinking Instead{' '}<span style={{ ...heroStyles.h1Accent, color: 'var(--green)' }}>(7 Reasons)</span></>)}
          </h1>
